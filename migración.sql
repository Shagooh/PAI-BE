...
CREATE SEQUENCE public.habilitaciones_id_seq AS integer START
WITH
...
CREATE TABLE public.usuarios (
    ...
    equipo_tratante character varying(150),
    estado_motivacional character varying(120),
...
ALTER COLUMN id
SET DEFAULT nextval(
    'public.habilitaciones_id_seq'::regclass
);
...
COPY public.usuarios (rut, nombre, apellido, edad, fecha_nacimiento, equipo_tratante, estado_motivacional, programa, created_at) FROM stdin;
18.768.749-7	Santiago	Rodriguez	23	2003-07-31	Equipo A	Alto	Programa Integral	2026-07-31 00:56:24.911289
\.
